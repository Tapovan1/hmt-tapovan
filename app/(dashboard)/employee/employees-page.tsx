          ...
          <Table>
            <TableHeader>
              <TableRow className="hover:bg-transparent border-gray-200">
                <TableHead className="font-medium text-center text-gray-700 py-3">Employee</TableHead>
                <TableHead className="font-medium text-center text-gray-700 py-3">Department</TableHead>
                <TableHead className="font-medium text-center text-gray-700 py-3">Role</TableHead>
                <TableHead className="font-medium text-center text-gray-700 py-3">Email</TableHead>
                <TableHead className="font-medium text-center text-gray-700 py-3">Actions</TableHead>
              </TableRow>
            </TableHeader>
              ...
              {filteredEmployees.length === 0 ? (
                ...
                filteredEmployees.map((employee) => (
                  <TableRow key={employee.id} className="hover:bg-gray-50/50 border-b border-gray-100">
                    ...
                    <TableCell className="py-2.5 text-center text-gray-600">{employee.email}</TableCell>
...
function RoleBadge({ role }: { role: string }) {
  switch (role) {
    case "ADMIN":
      return <Badge className="bg-blue-100 text-blue-800 hover:bg-blue-100 font-normal">Admin</Badge>
    case "SUPERADMIN":
      return <Badge className="bg-blue-100 text-blue-800 hover:bg-blue-100 font-normal">Super Admin</Badge>
    case "TEACHER":
      return <Badge className="bg-green-100 text-green-800 hover:bg-green-100 font-normal">Teacher</Badge>
    case "TEACHERE":
      return <Badge className="bg-green-100 text-green-800 hover:bg-green-100 font-normal">Teacher</Badge>
    case "SECURITY":
      return <Badge className="bg-yellow-100 text-yellow-800 hover:bg-yellow-100 font-normal">Security</Badge>
    default:
      return (
